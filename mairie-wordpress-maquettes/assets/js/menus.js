export function burgerMenu () {
    ...
    burgerMenuButton.addEventListener('click', function () {
        ...
        if (menu.getAttribute('class') === 'active') {
            burgerMenuButton.setAttribute('src', 'https://img.icons8.com/sf-regular-filled/48/multiply.png');
            burgerMenuButton.setAttribute('alt', 'multiply');
        } else {
            burgerMenuButton.setAttribute('src', 'https://img.icons8.com/fluency-systems-filled/48/menu.png');
